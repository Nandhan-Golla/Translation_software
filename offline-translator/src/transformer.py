class Translator:
    def __init__(self, src_lang: str = 'en', tgt_lang: str = 'es'):
        ...
        # Initialize with dummy vocab sizes - should be updated with real data
        self.model = TranslationModel(
            src_vocab_size=10000,
            tgt_vocab_size=10000
        ).to(self.device)
        
        self.src_vocab = {}  # To be populated
        self.tgt_vocab = {}  # To be populated
        self.inv_tgt_vocab = {}  # For decoding
    ...
    def train(self, src_sentences: List[str], tgt_sentences: List[str], epochs: int = 10):
        ...
        # Reinitialize model with actual vocab sizes
        self.model = TranslationModel(
    ...
    def build_vocabulary(self, src_sentences: List[str], tgt_sentences: List[str]):
        # Simple vocabulary building - in practice, you'd want to limit vocab size
